...
class PermissionViewSet(viewsets.ModelViewSet):
    ...
    queryset = Permission.objects.select_related('resource', 'action').all()
    ...
    def create_by_names(self, request):
        ...
        permission, created = Permission.get_or_create_permission(resource_name, action_name)
...
class UserRoleViewSet(viewsets.ModelViewSet):
    """ViewSet для управления назначениями ролей пользователям (только для администраторов)."""
