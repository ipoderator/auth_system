...
class Resource(models.Model):
    ...
    name = models.CharField(max_length=100, unique=True, db_index=True, verbose_name='Resource name')
...
class Action(models.Model):
    """Action model - represents actions that can be performed on resources."""
    
    name = models.CharField(max_length=50, unique=True, db_index=True, verbose_name='Action name')
    description = models.TextField(blank=True, verbose_name='Description')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Created at')
...
class Role(models.Model):
    ...
    name = models.CharField(max_length=100, unique=True, db_index=True, verbose_name='Role name')
    description = models.TextField(blank=True, verbose_name='Description')
